...
/* harmony default export */ __webpack_exports__["a"] = (Form); //#e2b04a #ff3019
...
// CONCATENATED MODULE: ./components/styles/OrderProductStyles.js

var OrderProductStyles = external_styled_components_default.a.li.withConfig({
  displayName: "OrderProductStyles",
  componentId: "sc-1g00hfy-0"
})(["box-shadow:", ";list-style:none;padding:2rem;border:1px solid ", ";h2{border-bottom:2px solid green;margin-top:0;margin-bottom:2rem;padding-bottom:2rem;}.images{display:grid;grid-gap:10px;grid-template-columns:repeat(auto-fit,minmax(0,1fr));margin-top:1rem;img{height:200px;object-fit:cover;width:100%;}}.order-meta{display:grid;grid-template-columns:repeat(auto-fit,minmax(20px,1fr));display:grid;grid-gap:1rem;text-align:center;& > *{margin:0;background:rgba(0,0,0,0.03);padding:1rem 0;}strong{display:block;margin-bottom:1rem;}}"], function (props) {
  return props.theme.bs;
}, function (props) {
  return props.theme.offWhite;
});
/* harmony default export */ var styles_OrderProductStyles = (OrderProductStyles);
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        return external_react_default.a.createElement("div", null, external_react_default.a.createElement("h2", null, "You have ", orders.length, " orders"), external_react_default.a.createElement("orderUl", null, orders.map(function (order) {
          return external_react_default.a.createElement(styles_OrderProductStyles, {
            key: order.id
