...
var SingleProductStyles = external_styled_components_default.a.div.withConfig({
  ...
  _createClass(SingleProduct, [{
    ...
    value: function render() {
      return external_react_default.a.createElement(external_react_apollo_["Query"], {
        ...
        if (loading) return external_react_default.a.createElement("p", null, "Loading..."); //if (!data.product) return <p>No Product Found for {this.props.id}</p>;

        var product = data.product;
        return external_react_default.a.createElement(SingleProductStyles, null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, "Price Deal | ", product.title)), external_react_default.a.createElement("img", {
          src: product.largeImage,
          alt: product.title
        }), external_react_default.a.createElement("div", {
          className: "details"
        }, external_react_default.a.createElement("h2", null, "Viewing ", product.title), external_react_default.a.createElement("p", null, product.description)));
      });
    }
  }]);
...
var product_Product = function Product(props) {
  return external_react_default.a.createElement("div", null, external_react_default.a.createElement(components_SingleProduct, {
    id: props.query.id
  }));
};
